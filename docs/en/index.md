...
[I want to contribute](contributing/index.md){ .intro-contribute }

[Donate and support us!](membership/index.md){ .intro-donate }
...
![Python logo](images/python.png){ .index-right-logo }
...
![Cross-platform](images/cross-platform.png){ .index-left-logo }
...
## ...behaving natively. { .behaving-index }

![Native](images/native.png){ .index-right-logo }
...
![Brutus the Bee](images/brutus-97.png){ .index-left-logo }
...
![Open source](images/opensource.png){ .index-right-logo }
...
![Hands](images/labhr.png){ .index-left-logo }
...
![Diversity](images/diversity.png){ .index-right-logo }
