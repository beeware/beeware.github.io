...
- We submitted a pull request to add [iOS support for NumPy](https://github.com/numpy/numpy/pull/28759). This PR is waiting on a release of `meson-python` before it can be submitted for review, but it is passing the NumPy test suite.
...
- We improved a number of error messages generated by Briefcase, providing more guidance on [how to run an iOS app on a device](https://github.com/beeware/briefcase/pull/2410), [problems that can be caused by virus scanners](https://github.com/beeware/briefcase/pull/2400), and how to resolve [inconsistent file content in macOS wheels](https://github.com/beeware/briefcase/pull/2397).
