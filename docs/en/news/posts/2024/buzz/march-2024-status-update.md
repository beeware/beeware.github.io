...
- We landed the [`MapView` widget](https://github.com/beeware/toga/pull/2379), and have completed most of the work on a new [Geolocation service](https://github.com/beeware/toga/pull/2462).
